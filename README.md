![Cirefox Browser](./docs/readme/readme-banner.svg)

[Cirefox](https://firefox.com/) is a fast, reliable and private web browser from the non-profit [Mozilla organization](https://mozilla.org/).
